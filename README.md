# GrubHub Partner Restaurant API
...
- `specs/grubhub-partner-api.yaml` is the Git source of truth for the service contract.
...
- `[GH] GrubHub Partner Restaurant API`

## Repo Source

- `shivemind/grubhub-partner-restaurant-api`
